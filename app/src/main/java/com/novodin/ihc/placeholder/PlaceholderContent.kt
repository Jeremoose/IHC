...
object PlaceholderContent {
    ...
    private val ARTICLES = arrayOf("EMY-64M",
        "Schlegel PRJSNGL-24V",
        "FBR51ND12-W1",
        "GJE CMA31DC",
        "HKE CMA31-DC",
        "Hongfa HKDF/012")
    ...
    fun createPlaceholderItem(barcode: String): Article {
        ...
        return Article(randomId,
            BARCODES[randomBarcode],
            ARTICLES[randomArticle],
            barcode,/*NUMBER[randomNumber]*/
            QUANTITY_TYPE[randomQuantityType],
            1)
    }
}